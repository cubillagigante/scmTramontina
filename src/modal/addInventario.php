...
<div id="modalg" class="p-8 h-[20em] z-40 inset-y-[30%] inset-x-[30%] absolute w-[40%] rounded-xl overflow-hidden border bg-white">
    <form id="formAdd" onsubmit="btn(event);return false;" data-table="almacen">
        ...
        <div class="p-2 text-black w-full flex justify-between items-center">
            ...
            <input name="nombre" id="i-des" class="camposform w-[80%] p-2 rounded-lg border text-center" type="text" placeholder="ej: Almacen1" required/>
        </div>
        <div class="p-2 text-black w-full flex justify-between items-center">
            <label for="i-ubi">Ubicación:</label>
            <input name="ubicacion" id="i-ubi" class="camposform w-[80%] p-2 rounded-lg border text-center" type="text" placeholder="maps.google" required/>
        </div>
        <div class="hidden p-2 text-black w-full justify-between items-center">
            <label for="i-ubi">Estado:</label>
            <input value="1" name="estado" id="i-ubi" class="camposform w-[80%] p-2 rounded-lg border text-center" type="text" placeholder="1" required/>
        </div>
